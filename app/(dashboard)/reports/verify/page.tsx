...
import { useVerifyReports, useOnlyBranchList, useModulePermissions } from "@/lib/hooks";
...
export default function VerifyReportPage() {
  ...
  // Live data fetching hook via GET /report/verify
  const { data: apiResponse, isLoading, isFetching } = useVerifyReports({
    page,
    limit,
    search,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
            ...
            {isAdminOrSuperAdmin ? (
              ...
              <div className="space-y-1">
                ...
                <div className="h-8.5 px-2.5 flex items-center rounded-md border border-slate-200 bg-slate-50 text-xs text-slate-700 font-medium">
                  Current Branch
                </div>
              </div>
            )}
