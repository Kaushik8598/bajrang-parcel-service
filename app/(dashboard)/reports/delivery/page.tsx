...
import { useParcelDeliveredReports, useOnlyBranchList, useModulePermissions } from "@/lib/hooks";
...
export default function ParcelDeliveryReportPage() {
  ...
  // Live data fetching hook via GET /report/delivered
  const { data: apiResponse, isLoading, isFetching } = useParcelDeliveredReports({
    page,
    limit,
    search,
